...
<ul>
    <li> ('25.04~'26.02) [SK에너지] 설비관리 작업요청 AI기반 추천시스템 제안 및 개발
...
<ul>
    ...
    <li>('23.05~'23.06) XGBoost를 이용한 음악 장르 분류모델 구축 및 유사곡 추천
    ...
    <li>('22.09) 텍스트마이닝과 지오코딩을 활용한 해외 제조업소를 분류하는 알고리즘 구축
...
### 💪 Experience 💪
<ul>
    <li>('26.06~) kt cloud tech up-생성형AI 과정 수강 중</li>
    <li>('23.06~'23.08) 데이터 청년 캠퍼스-고려대학교 과정 수료</li>
    <li>('22.09~'23.02) 식품안전정보원 정보화사업실 통합정보시스템부 인턴십</li>
    <li>('22.06~'22.08) 데이터 분석 청년인재 양성사업 교육 수료</li>
    <li>('20.09~'22.08) 교내 데이터 분석 동아리 Daja Vu 활동 수료</li>
</ul>
